...
function MyPageMain() {
      ...
      try {
        ...
        const records = Object.entries(grouped).map(([date, items]) => {
          ...
          items.forEach((i) => {
            ...
            if (!exerciseMap[name]) {
              exerciseMap[name] = { exerciseId: i.exerciseId, name, durationMin: 0, burntCalories: 0 };
            }
  ...
  const weeklyCalorieData = useMemo(() => {
    ...
    return {
      ...
      datasets: [
        { label: "지난주", data: lastWeek, backgroundColor: "#DFF0FF", borderColor: "#A7D6FF", borderWidth: 1 },
        { label: "이번주", data: thisWeek, backgroundColor: "#D9FFD5", borderColor: "#AFE1AA", borderWidth: 1 },
      ],
    };
  }, [exerciseRecords]);
    ...
    <div className="wrap !bg-light-02 !mt-0 md:min-h-[calc(100vh-180px)] flex justify-center items-center">
      <header className="relative w-full h-[300px] overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
          ...
          <p className="text-white">매일 작은 변화들을 쌓아가며, 건강한 습관을 만들어보세요!</p>
          <p className="text-white">조금씩달라지는 몸과 마음이 스스로에게 가장 큰 보상이 됩니다.</p>
        </div>
      </header>
        ...
        <section className="helpme mt-[3%] pb-[10%]">
          <ul className="w-full flex flex-row gap-y-15 justify-between flex-wrap">
            ...
            <li className="w-full md:w-[45%] lg:w-[30%]">
              <Link to="foodhistory" className="flex flex-col justify-center items-center">
            ...
            {/* 나의 운동 기록 */}
            <li className="w-full md:w-[45%] lg:w-[30%]">
              <Link to="healthhistory" className="flex flex-col justify-center items-center">
            ...
            {/* 주간 체중 기록 */}
            <li className="w-full md:w-[45%] lg:w-[30%]">
              <Link to="weekhistory" className="flex flex-col justify-center items-center">
            ...
            {/* 나의 커뮤니티 활동 */}
            <li className="w-full md:w-[45%] lg:w-[30%]">
              <Link to="cmhistory" className="flex flex-col justify-center items-center">
            ...
            {/* 오늘의 식단 추천 */}
            <li className="w-full md:w-[45%] lg:w-[30%]">
              <Link to="foodmanagement" className="flex flex-col justify-center items-center">
            ...
            {/* 내정보 수정 */}
            <li className="w-full md:w-[45%] lg:w-[30%]">
              <Link to="myinfo" className="flex flex-col justify-center items-center">
